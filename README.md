...
This is a forked version of FLBEIA to integrate size-based multispecies population dynamics using Mizer.

## Package in development and not get ready for use.
## Overview
